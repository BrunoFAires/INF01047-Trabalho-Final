...
// A variável gl_Position define a posição final de cada vértice
    ...
    vec4 l = normalize(vec4(5.0,5.0,5.0,0.0)- position_world);
    ...
    buttonColor.rgb = lambert + ambient_term + blinn_phong_specular_term;
    buttonColor.a = 1;
    ...
    // Alpha default = 1 = 100% opaco = 0% transparente
        ...
        buttonColor.rgb = pow(buttonColor.rgb, vec3(1.0,1.0,1.0)/2.2);
    }
